...
export const translations = {
  ...
  digests_subtitle_all: { zh: "按词条查看历史内容并维护高级设置", en: "Browse keyword history and manage advanced settings" },
  digests_subtitle_kw: { zh: "关键词「{kw}」的历史内容与设置", en: 'History and settings for "{kw}"' },
