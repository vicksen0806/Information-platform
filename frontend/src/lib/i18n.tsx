...
export const translations = {
  ...
  nav_digests: { zh: "词条设置", en: "Keyword Settings" },
  nav_keywords: { zh: "关键词", en: "Keywords" },
  nav_settings: { zh: "系统设置", en: "System Settings" },
  ...
  // Digests page
  digests_title: { zh: "词条设置", en: "Keyword Settings" },
  digests_subtitle_all: { zh: "按词条查看历史内容，并按需清空历史后重新抓取", en: "Browse keyword history and clear it when you need a fresh recrawl" },
  digests_subtitle_kw: { zh: "关键词「{kw}」的历史内容与清理操作", en: 'History and reset controls for "{kw}"' },
  ...
  digests_clear_history: { zh: "清空当前词条", en: "Clear current keyword" },
  digests_clearing_history: { zh: "清空中…", en: "Clearing..." },
  digests_clear_history_confirm: { zh: "清空关键词「{kw}」的全部历史记录？清空后当天可重新抓取该词条。", en: 'Clear all history for "{kw}"? This will allow the keyword to be crawled again today.' },
  digests_clear_history_done: { zh: "已清空关键词「{kw}」的历史记录。", en: 'Cleared the history for "{kw}".' },
  digests_clear_history_hint: { zh: "清空后可在同一天重新抓取该词条。", en: "After clearing, this keyword can be crawled again on the same day." },
  digests_clear_all_history: { zh: "清空所有词条", en: "Clear all keywords" },
  digests_clear_all_history_confirm: { zh: "清空全部词条的历史记录？清空后所有词条都可在同一天重新抓取。", en: "Clear history for all keywords? All keywords will be crawlable again today." },
  digests_clear_all_history_done: { zh: "已清空全部词条的历史记录。", en: "Cleared history for all keywords." },
  digests_clear_all_history_hint: { zh: "会删除全部词条历史，并重置当天复用记录。", en: "Deletes all keyword history and resets same-day reuse." },
  ...
  digests_history_sources_label: { zh: "来源：", en: "Sources:" },
  digests_advanced_title: { zh: "高级设置", en: "Advanced Settings" },
  digests_advanced_subtitle: { zh: "当前词条的分组、抓取说明和来源设置", en: "Grouping, crawl notes, and source settings for the current keyword" },
  digests_advanced_source: { zh: "抓取来源", en: "Source" },
  digests_advanced_search: { zh: "Google News 自动搜索", en: "Google News auto-search" },
  digests_advanced_custom_url: { zh: "限定 URL", en: "Pinned URL" },
  digests_advanced_last_crawled: { zh: "最近抓取于 {t}", en: "Last crawled {t}" },
  digests_advanced_none: { zh: "尚未抓取", en: "Not crawled yet" },
  digests_advanced_save: { zh: "保存高级设置", en: "Save settings" },
  digests_advanced_group_hint: { zh: "分组请到关键词列表模块中管理", en: "Manage grouping from the keyword list module" },
  ...
  kw_subtitle_simple: { zh: "在“全部”中可选中词条生成分组；URL 和抓取说明请到词条设置页维护", en: "Select keywords under All to create groups; manage URLs and crawl settings in Keyword Settings" },
  kw_subtitle_group: { zh: "当前在“{group}”分组中添加词条，新词会直接归入该分组", en: 'Adding keywords to "{group}" — new items will be assigned to this group' },
  kw_list_title: { zh: "关键词列表", en: "Keyword List" },
  kw_history_hint_title: { zh: "近 1 个月抓取过的历史词条，点击可重新加入", en: "Keywords crawled in the last month — click to add back" },
  kw_add: { zh: "添加", en: "Add" },
  ...
  kw_group_all: { zh: "全部", en: "All" },
  kw_group_custom: { zh: "自定义", en: "Custom" },
  kw_group_generate: { zh: "生成分组", en: "Create Group" },
  kw_group_prompt: { zh: "请输入分组名称", en: "Enter a group name" },
  kw_group_delete_confirm: { zh: "删除分组“{group}”？该分组下的词条会保留，但会移出分组。", en: 'Delete group "{group}"? Keywords will be kept, but removed from this group.' },
  kw_group_assign: { zh: "分组", en: "Group" },
  kw_group_none: { zh: "未分组", en: "Ungrouped" },
  kw_group_empty: { zh: "该分组下暂无词条", en: "No keywords in this group" },
  ...
  // Settings page
  settings_title: { zh: "系统设置", en: "System Settings" },
  ...
  settings_crawl_sources_title: { zh: "抓取来源", en: "Crawl Sources" },
  settings_crawl_sources_desc: { zh: "系统会优先按词条抓取当日最新内容；历史记录中会展示实际来源站点，例如 Google、LinkedIn、X 等，并可直接点击访问。", en: "The system prioritizes the latest content per keyword each day. History records show the actual source sites, such as Google, LinkedIn, or X, with direct links." },
